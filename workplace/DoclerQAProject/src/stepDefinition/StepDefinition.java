...
public class StepDefinition {
	...
	public void i_click_on_the_submit_button() throws Throwable {
		FormPageObjects.formSubmitBtn(driver).click();
		Thread.sleep(1000);
	}
	...
	@Then("^I delete the cookies and close the browser$")
	public void i_delete_the_cookies_and_close_the_browser() throws Throwable {
