...
public class DoclerQATest extends SetupTest {
	     ...
	     @Test
	     public void testFormPageBasicElementsAndBehavior() {
	     ...
	     public void testLogoBehavior() {
	    	 ...
	    	 HomePageObjects.testingLogo(driver).click();
	     ...
	     @Test
	     public void testFormPageElements() {
	    	 //Given I am on the http://uitest.duodecadits.com/ site
	     ...
	     @Test
	     public void testFormPageFunctionAndHelloPage() {
	    	 //Given I am on the http://uitest.duodecadits.com/ site
	    	 //And I am on the Form page
	    	 FormPageObjects.navigateToFormPage(driver);
	    	 /*    	 
	    	 ...
	    	 */
	    	 ...
	    	 for (String value : valueArray){
	    		 ...
	    		 //Go back, clear input and repeat with other inputs
	    		 GeneralObjects.browserBack(driver);
	    		 FormPageObjects.waitUntilInputAppears(driver);
	    		 FormPageObjects.formInput(driver).clear();	    		 
	    	 }
	     }    
